package springboot.backend.apirest.util;
...
import springboot.backend.apirest.models.services.CustomerServiceImpl;
...
import springboot.backend.apirest.models.services.ProductServiceImpl;


public class Util {


	public void orderListDetail(HttpServletRequest request, Order1 order1) {
